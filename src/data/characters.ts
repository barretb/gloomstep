...
export const CHARACTERS: CharacterTemplate[] = [
  ...
  {
    id: 'elf_sentinel_female', name: 'Elf Sentinel', race: 'Elf', className: 'Sentinel', ability: 'guard-stance',
    sprite: 'elf_sentinel_female', spriteFile: 'elf_sentinel_female.png',
    stats: { hp: 24, maxHp: 24, attack: 5, defense: 2, level: 1, xp: 0, xpToNext: 18 },
  },
  // Dwarves
  {
    id: 'dwarf_warrior_male', name: 'Dwarf Warrior', race: 'Dwarf', className: 'Warrior', ability: 'cleave',
  ...
  {
    id: 'dwarf_warrior_female', name: 'Dwarf Warrior', race: 'Dwarf', className: 'Warrior', ability: 'cleave',
    sprite: 'Dwarf_warrior_female', spriteFile: 'Dwarf_warrior_female.png',
    stats: { hp: 38, maxHp: 38, attack: 5, defense: 4, level: 1, xp: 0, xpToNext: 22 },
  },
  {
    id: 'dwarven_healer_female', name: 'Dwarven Healer', race: 'Dwarf', className: 'Healer', ability: 'mend',
  ...
  // Drow
  {
    id: 'drow_warrior_male', name: 'Drow Warrior', race: 'Drow', className: 'Warrior', ability: 'cleave',
  ...
  {
    id: 'drow_warrior_female', name: 'Drow Warrior', race: 'Drow', className: 'Warrior', ability: 'cleave',
