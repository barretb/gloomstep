...
const ITEMS: ItemTemplate[] = [
  ...
  // ── Swords ───────────────────────────────────────────────
  {
    ...
    item: { kind: 'weapon', slot: 'weapon', attackBonus: 1 },
    minDepth: 1,
  },
  {
  ...
  // ── Axes ─────────────────────────────────────────────────
  {
    ...
    item: { kind: 'weapon', slot: 'weapon', attackBonus: 3 },
    minDepth: 2,
  },
  {
  ...
  },
  {
    ...
    item: { kind: 'weapon', slot: 'weapon', attackBonus: 9 },
    minDepth: 7,
  },
  ...
  },
  {
    ...
    item: { kind: 'weapon', slot: 'weapon', attackBonus: 7 },
    minDepth: 5,
  },
  ...
  // ── Helmets ──────────────────────────────────────────────
  {
    ...
    item: { kind: 'armor', slot: 'head', defenseBonus: 1 },
    minDepth: 2,
  },
  {
    appearance: { name: 'Iron Helmet', char: '^', color: '#8888aa', sprite: 'helmet-iron' },
    item: { kind: 'armor', slot: 'head', defenseBonus: 2 },
    minDepth: 4,
  },
  ...
  // ── Gauntlets ────────────────────────────────────────────
  {
    ...
    item: { kind: 'armor', slot: 'hands', defenseBonus: 2 },
    minDepth: 4,
  },
];
